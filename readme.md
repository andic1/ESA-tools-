...
<img width="7534" height="844" alt="image" src="https://github.com/user-attachments/assets/b0675357-f4db-4ef5-8149-a1054b41aac2" />
...
- **边缘优先**：工具使用排行、推荐列表等全部在边缘函数上完成，贴近用户侧，降低延迟。
